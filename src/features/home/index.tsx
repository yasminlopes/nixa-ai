...
import { ArrowRight, KeyRound, PanelLeft, ShieldCheck, Sparkles } from 'lucide-react';
        ...
        <div className={styles.gateOverlay}>
          <div className={styles.gateInner}>
            <div className={styles.gateSteps}>
              ...
              <span style={{ opacity: gateState === 'index' ? 1 : 0.4 }}>02 Indexar</span>
            </div>
                ...
                <div className={styles.gateCardBody}>
                  <div className={styles.gateCardHead}>
                    ...
                    <p className={styles.gateDesc}>
                      Gemini (gratuita), OpenAI ou Ollama (local, sem custo) para gerar embeddings e
                      respostas.
                    </p>
                  </div>
                  ...
                  <div className={styles.gateNotice}>
                    ...
                    <p className={styles.gateNoticeText}>
                      Criptografada com <span className={styles.gateNoticeStrong}>AES-256-GCM</span>
              ...
              <button onClick={() => openModal('index')} className={styles.gateCard}>
                <div className={styles.gateCardBody}>
                  <div className={styles.gateCardHead}>
                    ...
                    <p className={styles.gateDesc}>
                      Chave configurada. Agora a Nixa precisa absorver as docs NICE/CXone para
                      começar a responder.
                    </p>
                  </div>
