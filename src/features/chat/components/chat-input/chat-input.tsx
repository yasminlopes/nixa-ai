  ...
  return (
    <div className={styles.wrapper}>
      ...
      <p className={styles.disclaimer}>
        A Nixa pode cometer erros ou trazer informações imprecisas. Sempre confirme nas fontes
        oficiais da documentação NICE/CXone.
      </p>
      <p className={styles.shortcuts}>↵ enviar &nbsp;·&nbsp; ⇧+↵ nova linha</p>
    </div>
  );
}
