...
import { AlertTriangle, Check, Cpu, Lock, Server, Trash2 } from 'lucide-react';
...
export function SettingsTab() {
  ...
  useEffect(() => {
    loadSettings();
    // Só na montagem: lê o estado inicial do storage do navegador.
  ...
  return (
    <div className={styles.wrapper}>
      ...
      <section className={styles.section}>
        ...
        {!isOllama && (
          <div className={styles.card}>
            ...
            <label className={styles.fieldLabel} htmlFor="api-key">
              API Key
            </label>
            <input
              id="api-key"
        ...
        {isOllama && (
          <div className={styles.card}>
            ...
            <p className={styles.ollamaHint}>
              Roda 100% local, sem chave. Basta ter o{' '}
              <code className={styles.inlineCode}>ollama serve</code> ativo.
            </p>
          </div>
        )}
      </section>
          ...
          <div className={styles.hostedNoticeInner}>
            ...
            <div>
              <p className={styles.hostedNoticeText}>
                ...
                <code className={styles.inlineCode}>localhost</code> do seu computador — use Gemini
                ou OpenAI. Para usar 100% local e sem custo, clone o repositório. O projeto é open
                source, contribuições são bem-vindas!
              </p>
              <a
      ...
      <div className={styles.securityNotice}>
        ...
        <span>
          Suas chaves ficam cifradas no seu navegador e são enviadas direto ao provedor — nunca
          ficam salvas no servidor.
          {updatedAt && (
