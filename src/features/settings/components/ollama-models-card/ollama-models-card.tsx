...
import { Brain, Check, Copy, Laptop, Zap } from 'lucide-react';
...
const OLLAMA_MODELS: OllamaModel[] = [
  ...
  },
  {
    name: 'llama3.1',
    size: '4.7 GB',
    desc: 'Melhor qualidade, exige 16GB+ RAM',
...

  {
    name: 'all-minilm',
    size: '46 MB',
    desc: 'Microscópico (384-dim)',
    pull: 'ollama pull all-minilm',
    badge: 'recomendado',
    category: 'embedding',
  },
  {
      ...
      <div className={styles.header}>
        ...
        <div className={styles.headerBody}>
          ...
          <p className={styles.headerSubtitle}>
            ...
            <code className={styles.headerCode}>OLLAMA_MODEL</code>. Quanto maior, melhor a
            qualidade — e mais RAM.
          </p>
        </div>
      </div>
        ...
        {models.map((model) => (
          <div key={model.name} className={styles.item}>
              ...
              <div className={styles.itemHead}>
                ...
                {model.badge && (
                  <span
                    className={clsx(
                      styles.itemBadge,
                      model.badge === 'recomendado' && styles.itemBadgeRecommended,
                    )}
                  >
                    {model.badge}
                  </span>
            ...
            <button
              ...
              className={clsx(
                styles.copyButton,
                copiedCmd === model.pull && styles.copyButtonActive,
              )}
              title={model.pull}
            >
